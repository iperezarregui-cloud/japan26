...
function DayItems({ day }) {
  ...
  function generatePlanningPrompt() {
    ...
    const sections = [
      ...
      '- afternoon_coffee debe ocurrir siempre después de lunch, antes de las principales visitas de tarde y con hora de inicio no posterior a las 16:00.',
      ...
      'Antes de devolver el JSON valida obligatoriamente: 1) todo beer_stop termina antes de que empiece lunch; 2) todo afternoon_coffee empieza después de terminar lunch; 3) no existe una visita principal entre lunch y afternoon_coffee; 4) afternoon_coffee empieza como máximo a las 16:00.',
      'Si cualquiera de estas cuatro comprobaciones falla, no generes el JSON: corrige y reconstruye primero el día completo.',

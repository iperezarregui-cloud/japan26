...
function DayItems({ day }) {
  ...
  function generatePlanningPrompt() {
    ...
    const sections = [
      ...
      '10. Prioriza Imprescindible y Alta, sin sobrecargar el día.',
      '11. Integra Comer y beber en momentos razonables y cerca del recorrido.',
      '12. Ordena las paradas de forma práctica y caminable cuando sea posible.',
      '13. Si alguna opción encaja mejor en otro día restante, déjala fuera del plan principal e indica en qué día o zona la colocarías.',
      '14. Si faltan actividades para completar la jornada, conserva tiempo libre. No cruces la ciudad para rellenar horas.',
      '15. No inventes lugares salvo en una sección opcional separada, y no los añadas al itinerario principal.',
      '16. Señala horarios, reservas o cierres que deban comprobarse.',
      '',

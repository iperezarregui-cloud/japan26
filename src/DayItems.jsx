...
function DayItems({ day }) {
  ...
  function generatePlanningPrompt() {
    ...
    const sections = [
      ...
      '- Después de comer queremos siempre el café de sobremesa antes de retomar las visitas principales de la tarde. La secuencia normal es comida → café de sobremesa → paseo o visitas de tarde.',
      '- No coloques una actividad principal entre la comida y el café de sobremesa. Solo puede haber un desplazamiento corto y directo hasta el café.',
      '- Si no existe una cafetería concreta que encaje de forma natural justo después de comer, crea una pausa flexible de café por la zona o prescinde de indicar un establecimiento, pero no retrases el café hasta después de otra visita.',
      ...
      '- afternoon_coffee debe ocurrir siempre después de lunch y antes de las principales visitas de tarde.',
      ...
      '- Confirma expresamente que lunch aparece antes de afternoon_coffee y que no hay una visita principal entre ambos.',
      ...
      'Antes de devolver el JSON valida que ningún afternoon_coffee aparezca antes de lunch ni después de una visita principal posterior a lunch.',
